...
if __name__ == "__main__": 
    ...
    #inputs
    num_workers = 8
    csv_file = './data_list_labelled.csv'
    csv_path = './data_list_labelled.csv'
    h5_path = './MRA_Data/patches/patches_labelled'
    ...
    ##Size of Train images patches

    train_patch_size = np.array([64, 64, 64])
    ##Size of Validation images patches
